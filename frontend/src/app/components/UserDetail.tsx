...
export function UserDetail() {
    ...
    return (
      <div className="p-4 md:p-6 lg:p-8">
        <div className="max-w-4xl mx-auto text-center py-12">
          <h2 className="text-xl md:text-2xl font-semibold text-gray-900 dark:text-white mb-2">User not found</h2>
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8">
      {/* Back Button */}
      <Link to="/" className="inline-flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white mb-4 md:mb-6 transition-colors">
        <ArrowLeft size={20} />
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 md:p-6 mb-4 md:mb-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div>
              <h1 className="text-xl md:text-2xl font-semibold text-gray-900 dark:text-white">{user.name}</h1>
                ...
                return (
                  <div
                    ...
                    className={`absolute top-0 h-full ${
                      segment.status === 'active' ? 'bg-green-500 dark:bg-green-400' : 'bg-red-400 dark:bg-red-500'
                    }`}
                    style={{
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 md:p-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
          ...
          <Tabs value={timeFilter} onValueChange={(v) => setTimeFilter(v as 'today' | 'week')}>
            <TabsList className="dark:bg-gray-900">
              <TabsTrigger value="today" className="dark:data-[state=active]:bg-gray-700 dark:text-gray-400 dark:data-[state=active]:text-white">Today</TabsTrigger>
              <TabsTrigger value="week" className="dark:data-[state=active]:bg-gray-700 dark:text-gray-400 dark:data-[state=active]:text-white">Last 7 Days</TabsTrigger>
            </TabsList>
          </Tabs>
        </div>
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-900/30 rounded-lg p-4 mb-6 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700 dark:text-blue-400 mt-1">
              Screenshots are automatically deleted after 7 days to save storage space.
            </p>
          </div>
        </div>
